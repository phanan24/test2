...
export class PDFGenerator {
  ...
  public downloadPDF = async (
    ...
    try {
      ...
      const content = this.createPDFContent(questions, {
        includeAnswers: options.includeAnswers !== false, // Default to true unless explicitly set to false
        includeExplanations: options.includeExplanations !== false, // Default to true unless explicitly set to false
        ...options
      });
